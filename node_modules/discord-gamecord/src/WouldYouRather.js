...
module.exports = class WouldYouRather extends events {
  ...
  async getWyrQuestion() {
    return await fetch('https://api-gamecord-e0cd45547eef.herokuapp.com/wyr').then(res => res.json()).then(res => res?.data).catch(e => { return {} });
  }

  async WyrQuestionVote(id, option) {
    return await fetch(`https://api-gamecord-e0cd45547eef.herokuapp.com/wyr/vote?id=${id}&option=${option}`).then(res => res.json()).catch(e => { return {} });
  }
